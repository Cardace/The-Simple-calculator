...
btnleft = tkinter.Button(root,text = '(',font = ('楷体',20),fg = ('black'),bd = 0.5,command = lambda:pressCompute('('))
btnleft.place(x = 0,y = 505,width = 75,height = 55)
btnright = tkinter.Button(root,text = ')',font = ('楷体',20),fg = ('black'),bd = 0.5,command = lambda:pressCompute(')'))
btnright.place(x = 75,y = 505,width = 75,height = 55)
btnsin = tkinter.Button(root,text = 'sin',font = ('楷体',20),fg = ('black'),bd = 0.5,command = lambda:presssin())
btnsin.place(x = 150,y = 505,width = 75,height = 55)
btncos = tkinter.Button(root,text = 'cos',font = ('楷体',20),fg = ('black'),bd = 0.5,command = lambda:presscos())
btncos.place(x = 225,y = 505,width = 75,height = 55)
...
def pressCompute(sign):
    ...
    global isPressSign
    global ispressright
    num = result.get()              #获取界面数
    if num == '0':
        pass
    elif ispressright==True:
        pass
    else:
